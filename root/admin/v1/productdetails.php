...
<html lang="en">
   ...
   <?php 
	...
	include_once('admin/v1/Utility.php');
   ...
   <body>
	                                    ...
	                                    <div class="col-md-12">
		                                    <div class="product-summery product-sidebar last">
		                                      <!-- <div class="product-quantity">
		                                       		...
		                                       		<span>You can order max 2 items</span>
		                                       </div>-->
		                                       <div class="action-btn mt-20">
                                               <a href="href="javascript:addtocart(<?php echo($postproductid);?>,'<?php echo($name);?>',<?php echo($currentprice);?>)"" class="btn btn-success btn-lg mb-10"><i class="fa fa-shopping-cart"></i> Add to cart</a>
      ...
      <footer>
      	<div class="container">
      		<div class="row">
      			<div class="col-md-12"><p>© Copyright 2017 DEALON.LIVE. All rights reserved.</p></div>
      		</div>
      	</div>
      </footer>
