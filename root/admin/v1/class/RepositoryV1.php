...
{	
	...
	*/
	public function ExecuteQuery($strSQL,&$strError)
	{
		try
		{
			...
			throw new Exception("Problem in executing query");
		}
		catch(Exception $e)
		{
			$strError=$e;
	...
	*/
	public function RetriveData($strSQL,&$strError)
	{
		...
		try
		{
			...
			throw new Exception("Problem in retrieving data");
	...
	*/
	public function BeginTransaction(&$strError)
	{
		try
		{
			...
			throw new Exception("Problem in opening transaction");
		}
		catch(Exception $e)
		{
			$strError=$e;
	...
	*/
	...
	{	
		...
		{
    		case "creativemine":
				$servername="172.245.177.162:3306";
				$username="creativemine";
				$password="iLk!BexIa72A";
				$databaseName="creativemine_appstudio";
				break;
				
				
			case "creativemineroot":
				$servername="helium.allsitecontrol.com:3306";
				$username="creativemine";
				$password="iLk!BexIa72A";
				$databaseName="creativemine_appstudio";
				break;
