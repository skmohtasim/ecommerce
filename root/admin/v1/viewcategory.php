...
$sqlcategory="select categoryid,categoryname,description from Categories order by categoryname";
         	...
         	<div class="col-md-12">
			  ...
			  ?>
                    ...
                    <tr>
                      ...
                      <td class="col-md-3"><?php echo($arrcategory[$i][1]); ?></td>
                      <td class="col-md-3"><?php echo($arrcategory[$i][2]); ?></td>
                     
                      <td class="col-md-2"><a href="editcategory.php?id= <?php echo($arrcategory[$i][0]) ; ?>">edit </a>|<a href="deletecircular.php?id= <?php echo($arrcategory[$i][0]) ; ?>">delete </a> </td>
